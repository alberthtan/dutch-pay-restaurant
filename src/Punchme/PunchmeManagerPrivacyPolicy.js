...
const PunchmeManagerPrivacyPolicy = () => {
    return (
        <div style={{margin: 20}}>
<>
  <style
        ...
        <strong>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="subtitle">
              Last updated <bdt className="question">April 02, 2023</bdt>
            </span>
          </span>
        </strong>
      </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">
            ...
            <bdt className="block-component" />
            <bdt className="question">DutchPay Inc.</bdt>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">
            ...
            <bdt className="question">
              <a
                href="https://dutch-pay-website.herokuapp.com"
                target="_blank"
                data-custom-class="link"
              >
                https://dutch-pay-website.herokuapp.com
              </a>
            </bdt>
                    ...
                    <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                      <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                        <span data-custom-class="body_text">
                          ...
                          log in to your account, as well as keep your account
                          in working order.
                          <span
                            style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}
                          >
...
export default PunchmeManagerPrivacyPolicy